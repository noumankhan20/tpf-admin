...
// CMS Modules Configuration — unchanged
const CMS_MODULES = [
  {
    id: 'hero',
    name: 'Hero Section',
...
// Category visual styles — mirrors SelectPanel's CAT_STYLES
const CAT_STYLES = {
  homepage: {
    ...
    <div className="mb-10">
      ...
      <div className="text-center">
        ...
        >
          ...
          <span className="text-xs font-bold uppercase tracking-wider">{totalModules} CMS Modules</span>
        </motion.div>
        ...
        >
          Content <span className="text-emerald-600">Management</span>
        </motion.h1>
