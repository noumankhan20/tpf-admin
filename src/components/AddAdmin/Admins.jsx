            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="w-full max-w-7xl mx-auto p-4 sm:p-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                        ...
                        {/* Button Container - Changed this part */}
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    {Array.isArray(admin.role) ? (
                                                        admin.role.map((role, index) => (
                                                            <span
                                                                key={index}
                                                                className={`px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${role.includes('Admin')
                                            ...
                                            <div className="space-y-2">
                                                {["SuperAdmin", "CMS Admin", "Volunteer Manager", "Campaign Manager"].map((role) => (
                                                    ...
                                                    >
                                                        <input
                                                            type="checkbox"
                                                            checked={selectedAdmin.role.includes(role)}
                                                            onChange={() => {
                                                                if (selectedAdmin.role.includes(role)) {
                                                                    setSelectedAdmin({
                                                                        ...selectedAdmin,
                                                                        role: selectedAdmin.role.filter((r) => r !== role),
                                                                    });
                                                                } else {
                                                                    setSelectedAdmin({
                                                                        ...selectedAdmin,
                                                                        role: [...selectedAdmin.role, role],
                                                                    });
                                                                }
                                                            }}
